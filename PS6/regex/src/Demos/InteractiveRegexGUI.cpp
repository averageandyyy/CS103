...
namespace {
    ...
    const vector<RegexInfo> kRegexes = {
        { "RegularExpressions.regexes", "[Part (i)]",   toAlphabet("abcde") },
        { "RegularExpressions.regexes", "[Part (ii)]",  toAlphabet("abcde") },
        { "RegularExpressions.regexes", "[Part (iii)]", toAlphabet("a/") },
        { "RegularExpressions.regexes", "[Part (iv)]",  toAlphabet("yd") },
        { "RegularExpressions.regexes", "[Part (v)]",   toAlphabet("MDCLXVI") },
        { "StateElimination.regexes",   "[Part (i)]",   toAlphabet("ab") },
        { "StateElimination.regexes",   "[Part (ii)]",  toAlphabet("ab") },
        { "StateElimination.regexes",   "[Part (iii)]", toAlphabet("ab") },
        { "StateElimination.regexes",   "[Part (iv)]",  toAlphabet("ab") },
        { "StateElimination.regexes",   "[Part (v)]",   toAlphabet("ab") },
    };
